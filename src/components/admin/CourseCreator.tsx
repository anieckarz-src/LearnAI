...
import { ArrowLeft, Save, Plus, Trash2, GripVertical, ChevronDown, ChevronUp, FileText, Folder, BookOpen } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
        <p className="text-blue-300 text-sm">
          💡 Po wypełnieniu szczegółów kursu, przejdź do zakładki "Moduły" aby dodać strukturę kursu, lub "Lekcje" aby szybko dodać lekcje.
        </p>
      </div>
    </form>
  </TabsContent>
